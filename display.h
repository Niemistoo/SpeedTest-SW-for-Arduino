...
/*
  ...
  Arduino pin 12 = serial to parallel component reset       SRCLR(inverted)
  Arduino pin 11 = serial to parallel component shiftClock  SRCLK
  Arduino pin 10 = serial to parallel component latchClock  RCLK??
  Arduino pin 9  = serial to parallel component outEnable   OE(inverted)
  Arduino pin 8  = serial to parallel component serialInput SER
